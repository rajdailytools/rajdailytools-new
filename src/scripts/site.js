  ...
  function initAccordions() {
    ...
    toggles.forEach(function (toggle) {
      toggle.addEventListener('click', function () {
        ...
        const isClosed = body.classList.contains('max-h-0') || body.classList.contains('hidden');
        if (isClosed) {
          body.classList.remove('max-h-0', 'opacity-0', 'pointer-events-none', 'hidden');
    ...
    // Expand All / Collapse All buttons in static mode
